export const MODULES = [
  {
    ...
    title: "Баланс сфер, энергий и активных контуров",
    description:
      "Колесо баланса, активные цели и события недели собраны в один экран, чтобы состояние системы было видно без переключений.",
  },
  {
    id: "former",
    label: "Формер",
    eyebrow: "Внутренняя стратегия",
    title: "Формер: смыслы, роли и опорные решения",
    description:
      "Здесь цели связываются с ценностями, ролями, анти-мотиваторами и личной историей, чтобы движение не разваливалось на случайные задачи.",
  },
  {
    id: "goals",
    label: "Цели",
    eyebrow: "План и прогресс",
    title: "Карта целей и планнер недели",
    description:
      "Каждая цель живет в своей сфере, разбита на этапы и попадает в планнер по дням, чтобы прогресс был виден как рабочий ритм, а не как абстракция.",
  },
  {
    id: "constructor",
    label: "Конструктор",
    eyebrow: "Создание цели",
    title: "Постановка цели без внутренних противоречий",
    description:
      "Конструктор проверяет смысл, этапы, ресурсы и пары поддержки, чтобы новая цель сразу была встроена в ритм недели и группы.",
  },
  {
    id: "contacts",
    label: "Контакты",
    eyebrow: "Менторы и мэйдеи",
    title: "Сеть наставников, мэйдеев и живых связей",
    description:
      "Связи строятся вокруг общих целей: здесь видно, кто помогает держать темп, кому можно написать и куда уже передана поддержка.",
  },
  {
    id: "feed",
    label: "Лента",
    eyebrow: "Напоминания и посты",
    title: "Лента групп, напоминаний и полезных материалов",
    description:
      "Лента соединяет события недели, контент из групп, напоминания по этапам и создание собственных публикаций в одном потоке.",
  },
  {
    id: "groups",
    label: "Группы",
    eyebrow: "Коллективный слой",
    title: "Группы поддержки по сферам жизни",
    description:
      "Группы собирают людей вокруг похожих задач. Подписка меняет ленту, а публикации и связанные цели становятся частью личной стратегии.",
  },
];
